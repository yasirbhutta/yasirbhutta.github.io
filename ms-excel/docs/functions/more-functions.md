---
layout: page
title: "Additional Excel Functions | Excel Formula Reference"
description: Explore a collection of additional Excel functions beyond the basics. Learn their uses, syntax, and practical examples to enhance your spreadsheet skills.
keywords: additional excel functions, advanced excel formulas, excel function list, lesser-known excel functions, excel tips and tricks, MS excel functions, excel formula guide, excel help, excel tutorial, excel reference functions, Insert copyright, registered and trademark symbols, Find unique list of cities using Unique Function
author: Muhammad Yasir Bhutta
course: ms-excel
topic: functions
toc: toc/ms-excel-toc.html
prev: /ms-excel/docs/functions/formula-errors.html
next: /ms-excel/docs/functions/more-functions.html
breadcrumb: 
- title: Functions
...
- [Video Tutorial: Excel Mobile | TOP 25 Tips to use Excel Mobile App - Microsoft 365](/ms-excel/videos/tips-excel.md)
