...
- [Python: Data Structures and Sequences](#python-data-structures-and-sequences)
  - [1. Tuple in Python](#1-tuple-in-python)
    - [Creating a Tuple in Python](#creating-a-tuple-in-python)
      - [Empty and single item tuple](#empty-and-single-item-tuple)
      - [Accessing the elements of Tuple](#accessing-the-elements-of-tuple)
      - [Unpacking tuples](#unpacking-tuples)
      - [Example #2](#example-2)
    - [Tuple methods](#tuple-methods)
  - [List](#list)
    - [Key Characteristics of Python Lists:](#key-characteristics-of-python-lists)
  ...
  - [Sets](#sets)
    - [Key Points about Sets:](#key-points-about-sets)
    - [Creating a Set](#creating-a-set)
    - [Example:](#example-1)
    - [Common Operations with Sets](#common-operations-with-sets)
    - [When to Use Sets?](#when-to-use-sets)
  - [Why Integers, Strings, and Tuples Are Immutable in Python \[1\]](#why-integers-strings-and-tuples-are-immutable-in-python-1)
    - [Integer (Immutable)](#integer-immutable)
  ...
  - [Multiple Choice (Select the best answer)](#multiple-choice-select-the-best-answer)
    - [Tuple (MCQs)](#tuple-mcqs)
    - [List (MCQs)](#list-mcqs)
    - [Dictionary (MCQs)](#dictionary-mcqs)
    - [Set (MCQs)](#set-mcqs)
  ...
  - [**Appendices**](#appendices)
    - [**Appendix A: Unordered Nature of Sets in Python**](#appendix-a-unordered-nature-of-sets-in-python)
      - [What Does "Unordered" Mean?](#what-does-unordered-mean)
      - [Example of Unordered Nature](#example-of-unordered-nature)
      - [Why Does This Happen?](#why-does-this-happen)
      - [Example: Adding Elements and Observing the Unordered Nature](#example-adding-elements-and-observing-the-unordered-nature)
      - [Implications of Being Unordered](#implications-of-being-unordered)
    - [Practical Uses of Unordered Sets](#practical-uses-of-unordered-sets)
    - [Summary](#summary)
