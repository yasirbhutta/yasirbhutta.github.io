...
- [Handouts - Python Language Basics](docs/basics.md)
...
- [Handouts: Variables](docs/variables.md)

- [Video: Variables in Python](https://www.youtube.com/watch?v=6fXy1ZpQc8c&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=59)
- [Vide: Python Variables and Assignment](https://www.youtube.com/watch?v=CRiu33tEDIM&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=105)
- [Video: Asterisk (*) in Variable Assignment (New)](https://www.youtube.com/watch?v=xCwfASassNs&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=3)

**Local and Global Variables:**
- [Video: Local vs Global Variables in Python](https://www.youtube.com/watch?v=WvAsrn5A2ms&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=7)
...
- [Handouts: Data Types](docs/data-types.md)
...
- [Handouts: Operators](docs/operators.md)
...
- [Handouts: Functions](docs/functions.md)
...
**Python def examples:**
- example #1: [How to Write a Python Function to Find the Length of a Word](https://www.youtube.com/watch?v=wKuKX8-at5E&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=22)
- example #2: [How to Find the Maximum Value in a List of Numbers](https://www.youtube.com/watch?v=AcC4ykPRYhc&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=23)
...
- [Handouts: Data Structures and Sequences](docs/dss.md)
...
- Python example: [Finding the maximum value in a list using a one-liner](https://www.youtube.com/watch?v=S-c7WrZSyaQ&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=4)
- Python example: [Find the sum of all even numbers between 1 and 100 using a one-liner](https://www.youtube.com/watch?v=tOxaYOtN-8s&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=3)
- Python example: [Counting the number of occurrences of an element in a list](https://www.youtube.com/watch?v=S2el4USCp5k&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=2)
...
- [Handouts: Python Sorting](docs/sorting.md)
...
- example #1: [Sorting a List of Colors by Length using Python's sorted() Function](https://www.youtube.com/watch?v=gt1YbVzwxXQ&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=54)
- example #2: [How to Sort a List of Fruit Tuples](https://www.youtube.com/watch?v=mtN5WCXzXyo&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=53)
- example #3: [Sorting a List of Dictionaries by Age using Lambda Function](https://www.youtube.com/watch?v=dRNiLVkPtRg&list=PLKYRx0Ibk7Vi-CC7ik98qT0VKK0F7ikja&index=52)
...
- [What is Class Constructor](https://youtube.com/shorts/eeat2bsZFL0)
